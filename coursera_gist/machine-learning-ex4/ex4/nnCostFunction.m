...
% ==================================Regularize grad=======================================
%add zeros and whatnot so you disregard grads for bias units
Theta1_grad_reg = [zeros1 Theta1(:,2:(input_layer_size+1))];
Theta2_grad_reg = [zeros2 Theta2(:,2:(hidden_layer_size+1))];

Theta1_grad += Theta1_grad_reg*(lambda/m);
Theta2_grad += Theta2_grad_reg*(lambda/m);
